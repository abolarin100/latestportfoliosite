...
import Da from "../assets/flowaid.png";
      ...
      <section className="services container section" id="projects">
        ...
        <div className="services__container grid">
          <div className="flex flex-col items-start space-y-[1px] bg-[#A7AEB91A] hover:scale-105  ">
            <img src={Da} alt="" className=" w-full object-cover" />
            <div className=" shadow-md shadow-gray-400 w-full rounded-b-md">
              <div className="flex flex-row justify-between pt-2 px-4">
                <div className="pt-2">
                  <h2 className="font-semibold">FlowAid </h2>
                  <div className="flex space-x-2 pt-2">
                    <p>
                      Humanitarian cash transfer system that streamlines the
                      distribution of resources to those in need.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-row justify-between px-4 pt-4 pb-4">
                <a href="https://github.com/abolarin100/FlowAid">
                  <button className="hover:bg-[#7b8ca71a] hover:scale-125 text-xs bg-[#415f8f1a] text-blue-500 border-1 border-blue-500">
                    GitHub
                  </button>
                </a>
                <a href="https://flow-aid-lac.vercel.app/">
                  <button className="hover:bg-[#a5b3c91a] hover:scale-125 text-xs bg-[#415f8f1a] text-blue-500 border-1 border-blue-500">
                    Live link
                  </button>
                </a>
              </div>
          ...
          <div className="flex flex-col items-start space-y-[1px] bg-[#A7AEB91A] hover:scale-105  ">
            <img src={Ga} alt="" className=" w-full object-cover" />
            <div className=" shadow-md shadow-gray-400 w-full rounded-b-md">
              <div className="flex flex-row justify-between pt-2 px-4">
                <div className="pt-2">
                  ...
                  <div className="flex space-x-2 pt-2">
                    <p>
                      An online learning platform for students taking the Data
                      analysis and Business Analysis courses.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-col items-start space-y-[1px] bg-[#A7AEB91A] hover:scale-105">
            <img src={La} alt="" className=" w-full object-cover" />
            <div className=" shadow-md shadow-gray-400 w-full rounded-b-md">
              <div className="flex flex-row justify-between pt-2 px-4">
                <div className="pt-2">
                  ...
                  <div className="flex space-x-2 pt-2">
                    <p>
                      Created to display my skills and expertise in developing
          ...
          <div className="flex flex-col items-start space-y-[1px] bg-[#A7AEB91A] hover:scale-105  ">
            <img src={Pa} alt="" className=" w-full object-cover" />
            <div className=" shadow-md shadow-gray-400 w-full rounded-b-md">
              <div className="flex flex-row justify-between pt-2 px-4">
                <div className="pt-2">
                  ...
                  <div className="flex space-x-2 pt-2">
                    <p>
                      A web app that allows users book deliveries, and easily
                      manage their package shipping needs.{" "}
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-col items-start space-y-[1px] bg-[#A7AEB91A] hover:scale-105">
            <img src={Ha} alt="" className=" w-full object-cover" />
            <div className=" shadow-md shadow-gray-400 w-full rounded-b-md">
              <div className="flex flex-row justify-between pt-2 px-4">
                <div className="pt-2">
                  ...
                  <div className="flex space-x-2 pt-2">
                    <p>
                      {" "}
                      A comprehensive online menu for browsing dishes, exploring
                      descriptions, and viewing visuals
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-col items-start space-y-[1px] bg-[#A7AEB91A] hover:scale-105  ">
            <img src={Ja} alt="" className=" w-full object-cover" />
            <div className=" shadow-md shadow-gray-400 w-full rounded-b-md">
              <div className="flex flex-row justify-between pt-2 px-4">
                <div className="pt-2">
                  ...
                  <div className="flex space-x-2 pt-2">
                    <p>
                      An online platform for job hunters to see the latest job
                      openings in their city.{" "}
                    </p>
                  </div>
                </div>
              </div>
